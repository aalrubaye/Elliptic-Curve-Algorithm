...
class Encoder{
        ...
        public static String[] cmp = new String[2];
        public static String[] decmp = new String[2];
        public static int[] lent= new int[2];
        ...
        */
        ...
        public Encoder addToSequence(BigInteger x1,BigInteger y1,BigInteger x2,BigInteger y2) {        	
        	String hex_x1,hex_y1,hex_x2,hex_y2;
        	hex_x1 = x1.toString(16);
        	hex_y1 = y1.toString(16); 
        	hex_x2 = x2.toString(16);
        	hex_y2 = y2.toString(16);
        	
        	
        	lent[0] = hex_x1.length();
        	lent[1] = hex_x2.length();
                	
        	decmp[0] = "04"+hex_x1+hex_y1;

        	if (y1.mod(BigInteger.valueOf(2)).equals(BigInteger.valueOf(1)))
        		cmp[0] = "03"+hex_x1;
        	else
        		cmp[0] = "02"+hex_x1;

        	if (!x2.equals(BigInteger.valueOf(0))){
        		decmp[1] = "04"+hex_x2+hex_y2;
        		if (y2.mod(BigInteger.valueOf(2)).equals(BigInteger.valueOf(1)))
        		cmp[1] = "03"+hex_x2;
        	else
        		cmp[1] = "02"+hex_x2;
        	}
